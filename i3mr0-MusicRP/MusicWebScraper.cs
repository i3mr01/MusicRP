...
namespace i3mr0_MusicRP {
    internal class MusicWebScraper
    {
        ...
        public MusicWebScraper(string songName, string songAlbum, string songArtist, string region, Logger? logger = null, string? lastFmApiKey = null) {
            this.logger = logger;
